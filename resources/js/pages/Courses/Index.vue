        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="course in myCourses" :key="course.id" 
            ...
            <div class="space-y-3 text-sm">
              <div v-if="course.course_code" class="flex items-center text-gray-600">
              ...
              <div v-if="course.time_slot" class="flex items-center text-gray-600">
              ...
              <div v-if="course.location" class="flex items-center text-gray-600">
              ...
              <div v-if="course.credits" class="flex items-center text-gray-600">
              ...
              <div v-if="course.desired_course" class="flex items-center text-gray-600">
                <svg class="w-4 h-4 mr-3 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                </svg>
                <span class="font-medium text-gray-700">欲交換課程:</span>
                <span class="ml-2 bg-orange-100 text-orange-800 px-2 py-1 rounded text-xs font-medium">{{ course.desired_course }}</span>
              </div>
            </div>
            ...
            <div class="mt-6 flex space-x-3">
              ...
              <template v-else>
                <button @click="deleteCourse(course.id)" 
                        class="flex-1 bg-red-50 hover:bg-red-100 text-red-700 font-medium text-center py-2.5 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center cursor-pointer">
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
